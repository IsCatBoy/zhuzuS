...
export default {
  ...
  mounted() {
    this.scrollToBottom();
    console.log("握手" + this.$store.state.UserInfoData.user_id);
    console.log("他是" + this.$route.params.chatname);
    this.bridge = [
      this.$store.state.UserInfoData.user_id,
      this.$route.params.chatname
    ];
    this.uid = this.$store.state.UserInfoData.user_id;
    this.nickname = this.$store.state.UserInfoData.user_id;
    let vm = this;
